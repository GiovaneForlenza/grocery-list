...
export default function ItemGrid({ itens, onAlterarQuantidade, onAlterarComprar }) {
  if (itens.length === 0) {
    return (
      <div className="flex flex-col items-center gap-3 rounded-2xl border border-dashed border-sage-dark/60 bg-white/60 px-6 py-16 text-center">
        ...
        <p className="font-display text-lg font-medium text-ink">Nenhum item encontrado</p>
